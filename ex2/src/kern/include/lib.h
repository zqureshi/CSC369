...
/*
 * The attribute notes that the variable may be unused in some of 
 * the files that include lib.h but that it should be marked as used
 * since it is required in some files. (This removes a warning.)
 */
